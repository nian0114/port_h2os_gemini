...
rm -rf output/app/LatinIME  output/app/OtaUpdaterInfo output/app/Nfc*  output/appLiveWallpapers  output/appNoiseField  output/app/OEMLogKit  output/app/OpenWnn
